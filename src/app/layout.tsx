  ...
  return (
    <html lang="id">
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="My Awesome PWA" />
        <meta name="description" content="A Progressive Web App with Google Play Store-like installation experience" />
